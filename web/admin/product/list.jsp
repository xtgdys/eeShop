...
<HEAD>
    ...
    <script type="text/javascript">
        ...
        function deleteProduct(pname, pid) {
            if (confirm("是否删除商品“" + pname + "”？")) {
                location.href = "${pageContext.request.contextPath}/admin?method=deleteProduct&pid=" + pid;
            }
                ...
                <table cellspacing="0" cellpadding="1" rules="all"
					...
					<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="18%">${product.pid}</td>
                            <td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">
                                <img width="40" height="45" alt="${product.pname}图片故障"
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <a href="javascript:void(0);" onclick="deleteProduct('${product.pname}', '${product.pid}')">
